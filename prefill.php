...
$fields = [
    ...
    'author_github_username' => ['pmartinez85',  '<username> in https://github.com/username',       ''],
    'author_email' =>           ['pmartinez1085@gmail.com',    '',                                                ''],
    'author_twitter' =>         ['xuxman85', '',                                                '@{author_github_username}'],
    ...
    'psr4_namespace' =>         ['pmartinez85\\',       'usually, Vendor\\Package',                        '{package_vendor}\\{package_name}'],
];
